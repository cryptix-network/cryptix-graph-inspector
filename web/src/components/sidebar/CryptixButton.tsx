...
const CryptixLogo = ({ appConfig }: {appConfig: AppConfig | null}) => {
            ...
            <Tooltip
                title={
                    <Box sx={{
                        ...
                        <strong>Cryptix Graph Inspector (KGI)</strong><br/>
                        <br/>
                        KGI: v{appConfig ? appConfig.webVersion : "n/a"}<br/>
                        Cryptixd: v{appConfig ? appConfig.cryptixdVersion : "n/a"}<br/>
                        <br/>
