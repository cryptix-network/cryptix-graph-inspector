...
import (
	...
	cryptixConfigPackage "github.com/cryptix-network/cryptixd/infrastructure/config"
	cryptixLogger "github.com/cryptix-network/cryptixd/infrastructure/logger"
...
type Flags struct {
	...
	cryptixConfigPackage.NetworkFlags
}
...
func LoadConfig() (*Config, error) {
	...
	if cfg.ShowVersion {
		...
		fmt.Println("cryptixd version", version.Version())
		os.Exit(0)
	}
	...
	if cfg.LogLevel == "show" {
		fmt.Println("Supported subsystems", cryptixLogger.SupportedSubsystems())
		os.Exit(0)
	}
	...
	if err := cryptixLogger.ParseAndSetLogLevels(cfg.LogLevel); err != nil {
